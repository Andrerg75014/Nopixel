	...
	menu = {
		...
		["sports"] = {
			...
			buttons = {
				...
				{model = "REVOLUTION6STR", name = "6STR Revolution", costs = 390000, description = {} }, 
				...
				{model = "COMET6STR", name = "6STR Comet", costs = 390000, description = {} }, 
				...
				{model = "comet3", name = "Comet Retro", costs = 325000, description = {} }, 
				...
				-- {model = "filthynsx", name = "Liberty Walk NSX", costs = 390000, description = {} },
				...
				-- {model = "dc5", name = "Honda Integra Type R", costs = 200000, description = {} },
				...
				-- {model = "500gtrlam", name = "Diablo GTR", costs = 390000, description = {} },
				...
				{model = "evo9", name = "Mitsubishi Lancer Evolution VI MR FQ-360", costs = 250000, description = {} },
...
local carTable = {
	[1] = { ["name"] = "Flash GT", ["model"] = "flashgt", ["baseprice"] = 200000, ["commission"] = 25 }, 
	[2] = { ["name"] = "Mitsubishi Lancer Evolution VI MR FQ-360", ["model"] = "evo9", ["baseprice"] = 250000, ["commission"] = 25 }, 
	[3] = { ["name"] = "Mazda RX7 FC", ["model"] = "fc3s", ["baseprice"] = 200000, ["commission"] = 25 }, 
	[4] = { ["name"] = "Nissan Skyline ER34", ["model"] = "er34", ["baseprice"] = 250000, ["commission"] = 25 }, 
	[5] = { ["name"] = "Zircoflow Stratum", ["model"] = "stratumc", ["baseprice"] = 250000, ["commission"] = 25 }, 
	[6] = { ["name"] = "Sultan RS MK2", ["model"] = "sultanrsv8", ["baseprice"] = 250000, ["commission"] = 25 }, 
	[7] = { ["name"] = "6STR Drift Tampa V2", ["model"] = "tampa5", ["baseprice"] = 250000, ["commission"] = 25 }, 
}
...
AddEventHandler("car:testdrive", function()
	...
	if rank == 0 or #(vector3(carSafeSpawn["x"],carSafeSpawn["y"],carSafeSpawn["z"]) - GetEntityCoords(PlayerPedId())) > 50.0 then
		return
	end	
...
function CloseCreator(name, veh, price, financed)
	Citizen.CreateThread(function()
		...
		if not boughtcar then
			...
			TriggerServerEvent('BuyForVeh69', name, vehicle, price, personalvehicle, primarycolor, secondarycolor, pearlescentcolor, wheelcolor, financed)
			DespawnSaleVehicles()
			SpawnSaleVehicles()
...
RegisterNetEvent("veh_shop:setPlate69")
AddEventHandler("veh_shop:setPlate69", function(vehicle, plate)
