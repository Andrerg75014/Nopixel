	...
	menu = {
		...
		["sportsclassics"] = {
			...
			buttons = {
				...
				-- {name = "Moonbeam Lowrider", costs = 275000, description = {}, model = "moonbeam2"},
		...
		["offroad"] = {
			...
			buttons = {
				...
				-- {name = "Lego Car", costs = 15000, description = {}, model = "kalahari"},
			}
		},
		["suvs"] = {
			title = "suvs",
...
function CloseCreator(name, veh, price, financed)
	Citizen.CreateThread(function()
		...
		if not boughtcar then
			...
			TriggerServerEvent('BuyForVeh', name, vehicle, price, personalvehicle, primarycolor, secondarycolor, pearlescentcolor, wheelcolor, financed)
			DespawnSaleVehicles()
			SpawnSaleVehicles()
