...
Citizen.CreateThread( function()
    ...
    while true do 
        ...
        if GetPedInVehicleSeat( veh, -1 ) == ped then
            ...
            if ( IsDisabledControlPressed( 1, 36 ) and IsDisabledControlJustPressed( 1, 243 ) and IsPedSittingInAnyVehicle( ped ) and isCop ) then 
            ...
            if ( not IsDisabledControlPressed( 1, 36 ) and IsDisabledControlJustPressed( 1, 243 ) and IsPedSittingInAnyVehicle( ped ) and isCop ) then 
                ResetFrontFast()
                ResetRearFast()
                TriggerEvent("DoShortHudText","Lockfast Reset",5)
            end 

            if ( IsDisabledControlJustPressed( 1, 244 ) and isCop and IsPedSittingInAnyVehicle( ped ) ) then 
