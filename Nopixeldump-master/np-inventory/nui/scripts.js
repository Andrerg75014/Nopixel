...
function UseBar(itemid, text) {
  ...
  htmlstring = "<div id='bind1'> " + text + " </div> <div class='item' > <div class='itemname'> " + name + " </div> <img src='icons/" + image + "' class='itemimage'>  </div>";
...
function ToggleBar(toggle, boundItems, boundItemsAmmo) {
  if (toggle) {
    ...
    if (boundItems[1]) {
      ...
      htmlstring = "<div id='bind1'> 1 </div> <div class='item' > <div class='itemname'> " + name + " </div> <img src='icons/" + image + "' class='itemimage'>  </div>";
    } else {

      htmlstring = "<div id='bind1'> 1 </div> <div class='item' > <div class='itemname'> unbound </div> <img src='icons/empty.png' class='itemimage'>  </div>";
    }
    ...
    for (let i = 2; i < 5; i++) {
      ...
      if (boundItems[i]) {
        ...
        htmlstring = htmlstring + "<div id='bind" + i + "'> " + i + " </div><div class='item' > <div class='itemname'> " + name + " </div> <img src='icons/" + image + "' class='itemimage'>  </div>";
      } else {

        htmlstring = htmlstring + "<div id='bind" + i + "'> " + i + " </div><div class='item' > <div class='itemname'> unbound </div> <img src='icons/empty.png' class='itemimage'>  </div>";
      }
...
function invStack(targetSlot, moveAmount, targetInventory, originSlot, originInventory, purchase, itemCosts, itemidsent, amountmoving, crafting, weapon) {
  let arr = [targetSlot, moveAmount, targetInventory, originSlot, originInventory, purchase, itemCosts, itemidsent, amountmoving, crafting, weapon, PlayerStore];
...
function BuildDrop(brokenSlots) {
  $.post("http://np-inventory/dropIncorrectItems", JSON.stringify({ slots: brokenSlots }));
}
...
function DisplayInventoryInit(sqlInventory, itemCount, invName, main) {
  ...
  for (let i = 0; i < itemCount; i++) {
    ...
    if (isEmpty(inventory[slot])) {
      ...
      var clear = JSON.parse(sqlInventory[i].information)
      inventory[slot].quality = clear.quality
      delete clear.quality
      inventory[slot].information = produceInfo(JSON.stringify(clear))
      // if single item, output id for item here for later use? hehe :)
  ...
  for (i = 0; i < slotLimit + 1; i++) {
    ...
    if (isEmpty(inventory[i])) {
      ...
      let htmlstring = "<div class='itemname'> " + name + " </div> <div class='information'>  " + itemcount + " (" + weight + ".00) </div>          <img src='icons/" + image + "' data-inventory='" + inventoryNumber + "' data-quality='" + quality + "' data-name='" + name + "' data-metainformation='" + meta + "' data-itemid='" + itemid + "' data-fwewef='" + item_cost + "' data-inventory='1' data-currentslot='" + slot + "' data-stackable='" + nonStack + "' data-amount='" + itemcount + "' data-weight='" + weight + "' data-inventoryname='" + inventoryName + "' class='itemimage'>";
      ...
      if (TargetInventoryName == "Shop" && main === false ) {
        ...
        htmlstring = "<div class='itemname'> " + name + " - $" + item_cost + " </div> <div class='information'>  " + itemcount + " (" + weight + ".00) </div>          <img src='icons/" + image + "' data-inventory='" + inventoryNumber + "' data-quality='" + quality + "' data-name='" + name + "' data-metainformation='" + meta + "' data-fwewef='" + item_cost + "' data-itemid='" + itemid + "' data-inventory='2' data-currentslot='" + slot + "' data-stackable='" + nonStack + "' data-amount='" + itemcount + "' data-weight='" + weight + "' data-inventoryname='" + inventoryName + "' class='itemimage'>";
      }
      ...
      if (TargetInventoryName == "Craft" && main === false) {
        ...
        htmlstring = "<div class='itemname'> " + name + " - craftable </div> <div class='information'>  " + itemcount + " (" + weight + ".00) </div>          <img src='icons/" + image + "' data-inventory='" + inventoryNumber + "' data-quality='" + quality + "' data-name='" + name + "' data-metainformation='" + meta + "' data-fwewef='" + item_cost + "' data-itemid='" + itemid + "' data-inventory='2' data-currentslot='" + slot + "' data-stackable='" + nonStack + "' data-amount='" + itemcount + "' data-weight='" + weight + "' data-inventoryname='" + inventoryName + "' class='itemimage'>";
      }
...
function UpdateSetWeights() {
  ...
  $.post("http://np-inventory/Weight", JSON.stringify({ weight: meh }));
}
...
function UpdateTextInformation(slot) {
  if (document.getElementById(slot)) {
    ...
    if (item) {
      let informationDiv = document.getElementById(slot).getElementsByTagName('div')[1];
...
function CompileStacks(targetSlot, originSlot, inv1, inv2, originAmount, targetAmount, moveAmount, purchase, itemCosts, itemidsent, moveAmount) {
  ...
  $.post("http://np-inventory/SlotJustUsed", JSON.stringify({ targetslot: targetSlot, origin: originSlot, itemid: itemidsent, move: false, MyInvMove: penis }));
  ...
  invStack(targetSlot, moveAmount, targetInventory, originSlot, originInventory, purchase, itemCosts, itemidsent, moveAmount, crafting, isWeapon);
...
function MoveStack(targetSlot, originSlot, inv1, inv2, purchase, itemCosts, itemidsent, moveAmount) {
  ...
  $.post("http://np-inventory/SlotJustUsed", JSON.stringify({ targetslot: targetSlot, origin: originSlot, itemid: itemidsent, move: true, MyInvMove: myInv }));
...
function SwapStacks(targetSlot, originSlot, inv1, inv2) {
  ...
  RequestItemData()
  $.post("http://np-inventory/SlotJustUsed", JSON.stringify({ targetslot: targetSlot, origin: originSlot, itemid: itemid, move: false, MyInvMove: penis }));
...
function closeInv(pIsItemUsed = false) {
  ...
  $.post("http://np-inventory/ServerCloseInventory", JSON.stringify({ name: TargetInventoryName }));
