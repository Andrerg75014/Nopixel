...
function SetDensity()
	...
	if isAllowedToSpawn then
		if primetime or cracktime or lunchtime or cocainetime then
	...
	if driving then dicks = "Driving" else dicks = "Not Driving" end
