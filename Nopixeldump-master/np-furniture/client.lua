...
function createNewObject(objType)
    ...
    curObject = CreateObject(GetHashKey(objType),crds["x"],crds["y"],crds["z"],false,false,false)
...
function updateDatabase(house_id,house_model)
  --  curObject = 0
    print("Updating " .. house_id .. " " .. house_model .. " objects " .. #modifiedObjects)
