...
function getDeal()
    ...
    if decryptType == 2 then
        print("rolling extra decrypt chance")
...
function payClient()
    ...
    print("area = " .. gangTaskArea)
    if gangTaskArea == "mexican" then
        print(myGangReputation["mexican"])
        payment = payment
        gangUp("mexican")
    end

    if gangTaskArea == "salva" then
        print(myGangReputation["salva"])
        payment = payment
        gangUp("salva")
    end

    if gangTaskArea == "weicheng" then
        print(myGangReputation["weicheng"])
        payment = payment
        gangUp("weicheng")
    end

    if gangTaskArea == "family" then
        print(myGangReputation["family"])
        payment = payment
        gangUp("family")
    end

    if gangTaskArea == "ballas" then
        print(myGangReputation["ballas"])
        payment = payment
        gangUp("ballas")
    end 
...
function attemptDecrypt()
    ...
    decrypting = false
    print("decrypt type = " .. decryptType)
    return true
end
